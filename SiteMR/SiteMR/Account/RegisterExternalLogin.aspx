<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="SiteMR.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="SiteMR" %>
